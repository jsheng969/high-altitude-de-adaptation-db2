...
@Schema(description = "管理后台 - 对照组体检-生化分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ControlExamBiochemicalTestsPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "18323")
