...
@Schema(description = "管理后台 - 实验组流调-服役信息分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyServiceInfoPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "15199")
