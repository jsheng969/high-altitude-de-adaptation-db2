package cn.iocoder.yudao.module.review.dal.dataobject.experimentdiseasespectrum;
 ...
 * @author 管理员
 */
@TableName("review_experiment_disease_spectrum")
@KeySequence("review_experiment_disease_spectrum_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ExperimentDiseaseSpectrumDO extends BaseDO {
