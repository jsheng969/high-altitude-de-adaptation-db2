package cn.iocoder.yudao.module.review.controller.admin.experimentdiseasespectrum.vo;
...
@Schema(description = "管理后台 - 实验组-疾病谱 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ExperimentDiseaseSpectrumRespVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "21939")
    @ExcelProperty("id")
    private Long id;

    @Schema(description = "基础信息id", requiredMode = Schema.RequiredMode.REQUIRED, example = "30723")
