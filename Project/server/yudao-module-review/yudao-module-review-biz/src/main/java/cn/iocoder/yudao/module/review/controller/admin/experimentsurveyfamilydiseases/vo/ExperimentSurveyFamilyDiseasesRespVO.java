...
@Schema(description = "管理后台 - 实验组流调-亲属既往疾病 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ExperimentSurveyFamilyDiseasesRespVO {
    ...
    @ExcelProperty("中风/脑溢血")
    private Boolean stroke;

    @Schema(description = "冠心病/心绞痛")
    @ExcelProperty("冠心病/心绞痛")
