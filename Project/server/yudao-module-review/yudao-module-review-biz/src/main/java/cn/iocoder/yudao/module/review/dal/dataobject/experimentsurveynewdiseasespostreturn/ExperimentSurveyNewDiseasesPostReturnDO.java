package cn.iocoder.yudao.module.review.dal.dataobject.experimentsurveynewdiseasespostreturn;
 ...
 * @author 芋道源码
 */
@TableName("review_experiment_survey_new_diseases_post_return")
@KeySequence("review_experiment_survey_new_diseases_post_return_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ExperimentSurveyNewDiseasesPostReturnDO extends BaseDO {
