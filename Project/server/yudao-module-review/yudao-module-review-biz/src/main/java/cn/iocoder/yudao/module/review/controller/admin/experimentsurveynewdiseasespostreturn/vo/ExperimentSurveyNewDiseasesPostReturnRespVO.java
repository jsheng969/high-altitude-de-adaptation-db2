package cn.iocoder.yudao.module.review.controller.admin.experimentsurveynewdiseasespostreturn.vo;
...
@Schema(description = "管理后台 - 实验组流调-返回平原后新发的疾病 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ExperimentSurveyNewDiseasesPostReturnRespVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "5161")
    @ExcelProperty("id")
    private Long id;

    @Schema(description = "基础信息id", requiredMode = Schema.RequiredMode.REQUIRED, example = "26000")
