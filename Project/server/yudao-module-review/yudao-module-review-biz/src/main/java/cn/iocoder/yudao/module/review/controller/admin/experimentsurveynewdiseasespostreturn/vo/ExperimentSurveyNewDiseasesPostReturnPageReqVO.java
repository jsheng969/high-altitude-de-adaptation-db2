...
@Schema(description = "管理后台 - 实验组流调-返回平原后新发的疾病分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyNewDiseasesPostReturnPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "26000")
