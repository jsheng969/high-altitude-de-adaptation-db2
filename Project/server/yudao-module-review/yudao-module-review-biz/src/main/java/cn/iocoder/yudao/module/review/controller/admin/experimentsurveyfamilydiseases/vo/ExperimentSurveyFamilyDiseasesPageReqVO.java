...
@Schema(description = "管理后台 - 实验组流调-亲属既往疾病分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyFamilyDiseasesPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "29820")
