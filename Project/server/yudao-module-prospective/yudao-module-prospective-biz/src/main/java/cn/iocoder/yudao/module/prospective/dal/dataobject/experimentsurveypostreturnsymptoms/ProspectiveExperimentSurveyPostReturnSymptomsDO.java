package cn.iocoder.yudao.module.prospective.dal.dataobject.experimentsurveypostreturnsymptoms;
 ...
 * @author 管理员
 */
@TableName("prospective_experiment_survey_post_return_symptoms")
@KeySequence("prospective_experiment_survey_post_return_symptoms_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ProspectiveExperimentSurveyPostReturnSymptomsDO extends BaseDO {
