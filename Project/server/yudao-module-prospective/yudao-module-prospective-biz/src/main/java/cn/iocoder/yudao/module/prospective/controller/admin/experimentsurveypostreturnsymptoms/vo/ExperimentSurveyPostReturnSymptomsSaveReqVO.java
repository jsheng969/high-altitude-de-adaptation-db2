package cn.iocoder.yudao.module.prospective.controller.admin.experimentsurveypostreturnsymptoms.vo;
...
@Schema(description = "管理后台 - 实验组流调-退役后返回平原1月内症状新增/修改 Request VO")
@Data
public class ExperimentSurveyPostReturnSymptomsSaveReqVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "27198")
    private Long id;

    @Schema(description = "基础信息id", requiredMode = Schema.RequiredMode.REQUIRED, example = "29555")
