...
@Schema(description = "管理后台 - 基本检测信息分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyBasicCheckInfoPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "19988")
