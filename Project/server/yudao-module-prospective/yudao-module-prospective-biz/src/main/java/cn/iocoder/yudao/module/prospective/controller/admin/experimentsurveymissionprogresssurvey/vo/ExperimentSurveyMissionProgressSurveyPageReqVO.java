...
@Schema(description = "管理后台 - 推进情况调查分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyMissionProgressSurveyPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "7127")
