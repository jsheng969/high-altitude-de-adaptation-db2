package cn.iocoder.yudao.module.prospective.controller.admin.controlexambiochemicaltestsv2.vo;
...
@Schema(description = "管理后台 - 实验组体检-生化v2新增/修改 Request VO")
@Data
public class ControlExamBiochemicalTestsV2SaveReqVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "17862")
    private Long id;
    ...
    @Schema(description = "总胆汁酸", example = "16945")
    ...
    @Schema(description = "尿酸", example = "26345")
    ...
    @Schema(description = "乳酸", example = "30237")
    ...
    @Schema(description = "PALB")
    private BigDecimal palb;

    @Schema(description = "TBIL")
    private BigDecimal tbil;

    @Schema(description = "DBIL")
    private BigDecimal dbil;

    @Schema(description = "TG")
    private BigDecimal tg;

    @Schema(description = "HDLC")
    private BigDecimal hdlc2;

    @Schema(description = "APO-A")
    private BigDecimal apoA2;

    @Schema(description = "APO-B")
    private BigDecimal apoB2;
