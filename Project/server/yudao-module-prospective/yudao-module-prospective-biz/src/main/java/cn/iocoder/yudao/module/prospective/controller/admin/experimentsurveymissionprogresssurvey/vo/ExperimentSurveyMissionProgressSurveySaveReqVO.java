package cn.iocoder.yudao.module.prospective.controller.admin.experimentsurveymissionprogresssurvey.vo;
...
@Schema(description = "管理后台 - 推进情况调查新增/修改 Request VO")
@Data
public class ExperimentSurveyMissionProgressSurveySaveReqVO {

    @Schema(description = "主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "18485")
    private Long id;

    @Schema(description = "基础信息id", requiredMode = Schema.RequiredMode.REQUIRED, example = "7127")
