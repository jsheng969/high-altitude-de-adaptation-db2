...
@Data
public class ControlExamBloodRoutineSaveReqVO {

    @Schema(description = "id", requiredMode = Schema.RequiredMode.REQUIRED, example = "20982")
    private Long id;

    @Schema(description = "基础信息id", requiredMode = Schema.RequiredMode.REQUIRED, example = "28397")
    ...
    @Schema(description = "BA%", requiredMode = Schema.RequiredMode.REQUIRED)
