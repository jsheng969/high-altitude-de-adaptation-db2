package cn.iocoder.yudao.module.prospective.dal.dataobject.controlexambiochemicaltestsv2;
 ...
 * @author 管理员
 */
@TableName("prospective_control_exam_biochemical_tests_v2")
@KeySequence("prospective_control_exam_biochemical_tests_v2_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ControlExamBiochemicalTestsV2DO extends BaseDO {
