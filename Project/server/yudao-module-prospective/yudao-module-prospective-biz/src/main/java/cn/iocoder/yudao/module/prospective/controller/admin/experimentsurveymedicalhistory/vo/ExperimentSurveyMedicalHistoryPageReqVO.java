...
@Schema(description = "管理后台 - 既往疾病史分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ExperimentSurveyMedicalHistoryPageReqVO extends PageParam {

    @Schema(description = "基础信息id", example = "14594")
