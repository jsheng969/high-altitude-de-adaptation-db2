package cn.iocoder.yudao.module.prospective.dal.dataobject.experimentexambloodroutine;
 ...
 * @author 管理员
 */
@TableName("prospective_experiment_exam_blood_routine")
@KeySequence("prospective_experiment_exam_blood_routine_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ProspectiveExperimentExamBloodRoutineDO extends BaseDO {
