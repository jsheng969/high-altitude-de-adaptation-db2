...
// 实验组体检-生化v2 VO
export interface ControlExamBiochemicalTestsV2VO {
  id: number // id
...
// 实验组体检-生化v2 API
export const ControlExamBiochemicalTestsV2Api = {
  // 查询实验组体检-生化v2分页
  getControlExamBiochemicalTestsV2Page: async (params: any) => {
    return await request.get({ url: `/prospective/control-exam-biochemical-tests-v2/page`, params })
  },

  // 查询实验组体检-生化v2详情
  getControlExamBiochemicalTestsV2: async (id: number) => {
    return await request.get({ url: `/prospective/control-exam-biochemical-tests-v2/get?id=` + id })
  },

  // 新增实验组体检-生化v2
  createControlExamBiochemicalTestsV2: async (data: ControlExamBiochemicalTestsV2VO) => {
    return await request.post({ url: `/prospective/control-exam-biochemical-tests-v2/create`, data })
  },

  // 修改实验组体检-生化v2
  updateControlExamBiochemicalTestsV2: async (data: ControlExamBiochemicalTestsV2VO) => {
    return await request.put({ url: `/prospective/control-exam-biochemical-tests-v2/update`, data })
  },

  // 删除实验组体检-生化v2
  deleteControlExamBiochemicalTestsV2: async (id: number) => {
    return await request.delete({ url: `/prospective/control-exam-biochemical-tests-v2/delete?id=` + id })
  },

  // 导出实验组体检-生化v2 Excel
  exportControlExamBiochemicalTestsV2: async (params) => {
    return await request.download({ url: `/prospective/control-exam-biochemical-tests-v2/export-excel`, params })
  }
}